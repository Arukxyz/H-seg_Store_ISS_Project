 ...
 * en el reporte de stock (RF-03) para distinguir de un vistazo qué tan
 * urgente es reponer cada producto.
 */
public enum EstadoStock {
    ...
    PROXIMO_A_AGOTAR("Próximo a agotar", "El stock se acerca al mínimo: conviene planear un pedido pronto."),
